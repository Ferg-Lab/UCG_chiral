...
PairStyle(table/ucg/dna,PairTableUCGDNA)

#else

#ifndef LMP_PAIR_TABLE_UCG_DNA_H
#define LMP_PAIR_TABLE_UCG_DNA_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTableUCGDNA : public Pair {
 public:
 PairTableUCGDNA(class LAMMPS *);
  virtual ~PairTableUCGDNA();
 ...
 protected:
  ...
  double compute_proximity_function(int, double); // SD
  double compute_proximity_function_der(int, double); // SD
